...
def main():
	...
	arcs_funcs.plot_most_likely_states(macrostates, probs, args.skirmish_dice, args.assault_dice, args.raid_dice, args.fresh_targets, 'arcs_test.png', args.convert_intercepts, args.truncate_length, args.show_full_plot, "light")
